...
module.exports.DBase = async () => {
    ...
    Order.sync().then(() => { console.log("listo 2") }).catch((error) => { console.error("Esto es el error 1", error) });
    Product.sync().then(() => { console.log("listo 3") }).catch((error) => { console.error("Esto es el error 2", error) });
